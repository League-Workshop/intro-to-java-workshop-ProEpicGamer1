...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("Tortured Person Screaming-SoundBible.com-63498375.wav"));
		...
		showScaryImage("creepy-trump2.png");
